...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`Hello WELCOME U MY OWNER🤗 @NOOBGUY_OP`
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/FINAL_STIKER_BOT?startgroup=true"),
    ],
...
HELP_STRINGS = """
`HELLO  [👿](https://telegra.ph/file/a5ff236ada8943cd9cf3b.mp4)
`MY FRND`"""
evil_IMG = "https://telegra.ph/file/a5ff236ada8943cd9cf3b.mp4"
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support  by contacting @NOOBGUY_OP \
